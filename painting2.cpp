...
////////////////////////////////////////////////////////////////////
//Problem 2 : (b)
//This code is the oil painting process of "coliseum.raw"
/////////////////////////////////////////////////////////////////////
#include <stdio.h>
#include <stdlib.h>
#include <iostream>
...
using namespace std;
 ...
 const int Size_W=580;        //the width of input image
 const int Size_H=247;         //the height of input image
...
/////////////////Divide input image into R, G and B//////////////
  ...
  /////////////////Changing to 64-color image/////////////////
   ...
   cout<<Level_Thrh[0]<<endl;
   cout<<Level_Thrh[1]<<endl;
   cout<<Level_Thrh[2]<<endl;
  ...
  ////////////////////////Write 64-color image/////////////////////////////
	ofstream tfile("quan64_coliseum_image.raw",ios_base::out | ios_base::binary);
	if (!tfile)
	{
  ...
  ///////////////////Write image/////////////////////
	ofstream ofile("oilpainting_Cimage.raw",ios_base::out | ios_base::binary);
	if (!ofile)
	{
		cout<<"open failed"<<endl;
		exit(1);	
